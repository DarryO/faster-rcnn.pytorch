...
if __name__ == '__main__':
    ...
    epoch_output_dir = os.path.join(output_dir, str(args.checkepoch))
    ...
    for i in range(num_images):
        ...
        if vis:
            cv2.imwrite('{}/{}/result_{}_{}.png'.format(output_dir, args.checkepoch, args.checkepoch, i), im2show)
            # pdb.set_trace()
