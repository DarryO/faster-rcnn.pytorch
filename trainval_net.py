...
if __name__ == '__main__':
    ...
    # ANCHOR_RATIOS: Anchor ratios for RPN
    # MAX_NUM_GT_BOXES: Maximal number of gt rois in an image during Training
    ...
    # the minimum value of (height, width) is in SCALES
    ...
    if args.resume:
        load_name = os.path.join(
                output_dir, 'faster_rcnn_{}_{}_{}.pth'.format(args.checksession, args.checkepoch, args.checkpoint))
